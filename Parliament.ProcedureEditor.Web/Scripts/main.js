...
var urls = {
    ...
    addSolrBusinessItem: "/solrfeed/businessitem/{tripleStoreId}",
    deleteSolrTreaty: "/solrfeed/treaty/{id}",
    deleteSolrStatutoryInstrument: "/solrfeed/statutoryinstrument/{id}",
    deleteSolrBusinessItem: "/solrfeed/businessitem/{tripleStoreId}",
...
define(["knockout", "jquery"], function (ko, $) {
    ...
    ko.components.register("series-membership-editor", { require: '/Scripts/Modules/seriesmembershipeditor.js' });    
});